...
export default function App() {
  ...
  //Blocca l'errore di testo popup di default del browser
  function handlePreventError(e) {
    e.preventDefault();
  }

  function handleInvalid(e) {
    //Blocca l'errore popup di default del browser
    e.preventDefault();
    //crea un msg custom in base al label dell'input
  ...
  function handleFileUpload(e) {
    ...
    // Error: se > di 150kByte, se il file esiste
    if (e.target.files[0]?.size > 500000) {
      ...
      //CreateObjectURL crea un URL temporaneo se il file esiste
      if (e.target.files[0]) {
  ...
  // si assicura che il bottone funzioni solo se il form è valido
  function handleSubmitValid(e) {
    // impedisce al form di essere inviato (ricaricare la pagina)
    e.preventDefault();
    setTicket(true);
  }
        ...
        <>
          ...
          <form className="form" onSubmit={handleSubmitValid}>
            ...
            <input
              ...
              required
            />
            {/* show error message when file > 500KB. It took me quite a while to come up with this. Default is null, so no message. Then the second if handle the state */}
            {fileSizeError === null ? (
              ""
            ) : !fileSizeError ? (
              <ErrorMsg>
            ...
            <input
              ...
              //genera il messaggio d'errore
              onInvalid={(e) => {
                handleInvalid(e);
              }}
              // Resetta il messaggio di errore quando si scrive
              onInput={() => {
                setErrorMsg("");
              }}
...
function Ticket({ imageURL, name, email, githubUsername }) {
  return (
    <>
      <h1 style={{ textAlign: "center" }}>
        ...
        <span
          style={{
            background: "linear-gradient(to right, hsl(7, 86%, 67%), white)",
            backgroundClip: "text",
      ...
      <p style={{ textAlign: "center", marginTop: "3rem" }}>
        ...
        <span style={{ color: "#f57261" }}>{email}</span> and will send upates
        in <br />
      ...
      <div className="ticket-container">
        ...
        <p style={{ position: "absolute", top: "25%", left: "13%" }}>
          Jan31, 2025 / Austin, TX
        </p>
        <img
          style={{
            position: "absolute",
        ...
        <p className="ticketCode">{`#${Math.floor(Math.random() * 100000)}`}</p>
      </div>
    </>
  );
}
...
function FrontendMentor() {
  return (
    <div className="attribution">
      ...
      Coded by{" "}
      <a href="https://github.com/calululu/React-conference-Ticket-Generator">
        Calu
      </a>
      .
    </div>
